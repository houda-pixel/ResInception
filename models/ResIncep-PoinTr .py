...
class Fold(nn.Module):
    def __init__(self, in_channel , step , hidden_dim = 512):
        ...
        self.folding1 = nn.Sequential(
             InceptionBlock(in_channel + 2, hidden_dim, hidden_dim//4, hidden_dim//2, hidden_dim//8, hidden_dim//4, hidden_dim//4, hidden_dim//2),
             InceptionBlock(hidden_dim//2, hidden_dim//4, hidden_dim//8, hidden_dim//4, hidden_dim//16, hidden_dim//8, hidden_dim//8, 3)
        )
